...
class alucross_v2
{
		...
		for(int a=0;a<9;a++)
		{
			if(a%2==0){
				...
				if((winner(userpos))==1) 
				{
					...
					System.out.println("You have earned yourself a trophy! Please visit your F: drive.");
					tro();
					break;
				}
			}	
				...
				if((winner(cpupos))==1)
				{
					...
					System.out.println("Try agian for winning the trophy!");
					break;
				}
			}
	...
	public static void tro()
	{
		FileWriter fw;
		BufferedWriter bw;
		try{
				fw= new FileWriter("f:/Trophy.txt");
